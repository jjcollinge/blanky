        ...
        private static void Main()
        {
            try
            {
                ...
                using (FabricRuntime fabricRuntime = FabricRuntime.Create())
                {
                    ...
                    fabricRuntime.RegisterServiceType("NodeMicroservice", typeof(NodeMicroservice));

                    ServiceEventSource.Current.ServiceTypeRegistered(Process.GetCurrentProcess().Id, typeof(NodeMicroservice).Name);
